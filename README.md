...
|           | user       | <id>   | --output <format> --context <name>          | Shows information about the user                             |       |
|           | room       | <id>   | --output <format> --context <name>          | Shows information about the room                             |       |
|           | scene      | <id>   | --output <format> --context <name>          | Shows information about the scene                            |       |
